...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for action_effect in node_a1.action.effect_add:
            if action_effect in node_a2.action.effect_rem:
                return True

        for action_effect in node_a2.action.effect_add:
            if action_effect in node_a1.action.effect_rem:
                return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        """
        for action_effect in node_a1.action.effect_add:
            if action_effect in node_a2.action.precond_neg:
                return True

        for action_effect in node_a1.action.effect_rem:
            if action_effect in node_a2.action.precond_pos:
                return True

        for action_effect in node_a2.action.effect_add:
            if action_effect in node_a1.action.precond_neg:
                return True

        for action_effect in node_a2.action.effect_rem:
            if action_effect in node_a1.action.precond_pos:
                return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        # Check if all parents of node_s1 are mutex with all parents from node_s2
